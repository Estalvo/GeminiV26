...
namespace GeminiV26.EntryTypes.Crypto
{
    public class BTC_PullbackEntry : IEntryType
    {
        ...
        private EntryEvaluation EvaluateDirectional(EntryContext ctx, TradeDirection forcedDirection)
        {
            ...
            {
                GlobalLogger.Log(this, $"[BTC_PULLBACK][HTF_NEUTRAL] conf={htfConf:0.00} keepDir={dir}");
            }
            ...
            GlobalLogger.Log(this, $"[BTC_PULLBACK][FUEL_APPLIED] fuel={fuelScore} newScore={score}");
            GlobalLogger.Log(this, $"[BTC_PULLBACK][FUEL] adxSlope={ctx.AdxSlope_M5:0.00} atrSlope={ctx.AtrSlope_M5:0.00} impulse={ctx.HasImpulse_M5} fuel={fuelScore}");
            ...
            if (ctx.BarsSinceImpulse_M5 > 3)
            {
                ...
                GlobalLogger.Log(this, $"[BTC_PULLBACK][SOFT] IMPULSE_AGE penalty={agePenalty} bars={ctx.BarsSinceImpulse_M5}");
            }
            ...
            if (grayZone)
            {
                ...
                score -= 4;
                GlobalLogger.Log(this, $"[BTC_PULLBACK][SOFT] GRAY_ZONE(-4) score={score} validPb={validPullbackReaction} adx={ctx.Adx_M5:0.0} volOk={ctx.IsVolatilityAcceptable_Crypto}");
            }
            ...
            if (isPullbackSetup && score < MIN_SCORE)
            {
                ...
                GlobalLogger.Log(this, $"[CRYPTO FILTER] pullback low confidence soft-penalty {prePenalty}->{score}");
            ...
            {
                GlobalLogger.Log(this, "[BTC FILTER] rejected: no impulse reclaim");
            ...
            {
                GlobalLogger.Log(this, $"[BTC FILTER] rejected: pullback timeout bars={ctx.PullbackBars_M5}");
            ...
            if (isPullbackSetup && isBtcSymbol && isAsiaSession)
            {
                ...
                GlobalLogger.Log(this, "[BTC ASIA] detected: session modifier active");
                ...
                {
                    GlobalLogger.Log(this, "[BTC ASIA] rejected: no directional drift quality");
                    ctx.Log?.Invoke(
                ...
                {
                    GlobalLogger.Log(this, $"[BTC ASIA] rejected: pullback too deep ratio={retracementRatio:0.00}");
                ...
                {
                    GlobalLogger.Log(this, $"[BTC ASIA] rejected: pullback too slow bars={ctx.PullbackBars_M5}");
                ...
                if (!reclaimConfirmed)
                {
                    GlobalLogger.Log(this, "[BTC ASIA] rejected: no reclaim confirmation");
                ...
                {
                    GlobalLogger.Log(this, $"[BTC ASIA] rejected: low confidence score={score}");
        ...
        {
            GlobalLogger.Log(this, $"[BTC_PULLBACK][BLOCK] {reason} | dir={dir} | score={score}");
