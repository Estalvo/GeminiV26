...
namespace GeminiV26.EntryTypes.Crypto
{
    public class BTC_FlagEntry : IEntryType
    {
        ...
        // =========================
        // DYNAMIC FLAG WINDOW (3–7 bars) -> pick tightest range
        // =========================
        int bestFlagStart = -1;
        ...
        // =========================
        // HI/LO for breakout (use chosen window)
        // =========================
        ...
        else if (dir == TradeDirection.Long)            score -= 6;

        if (dir == TradeDirection.Short && close < open) score += 6;
        else if (dir == TradeDirection.Short)            score -= 6;
        ...
        Score = score,
        IsValid = true,
        Reason = $"CR_TRUEFLAG dir={dir} score={score} flagBars={(flagEnd - flagStart + 1)} rangeATR={(range / ctx.AtrM5):F2}"
        };
        }
