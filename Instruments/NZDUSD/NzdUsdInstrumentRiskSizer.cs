...
{
    /// <summary>
    /// NZDUSD money-risk policy – Phase 3.8
    /// Policy szint:
    /// - Risk% (score alapján)
    ...
    /// </summary>
    public class NzdUsdInstrumentRiskSizer : IInstrumentRiskSizer
    {
        // =========================
        ...
        public void GetTakeProfit(
            ...
            out double tp2Ratio)
        {
            // NZDUSD: lassabb FX, de ha megy, szépen kifut
            tp1R = 0.3;
