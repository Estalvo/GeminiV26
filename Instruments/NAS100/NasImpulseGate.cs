...
namespace GeminiV26.Instruments.NAS100
{
    ...
    public class NasImpulseGate : IGate
    {
        ...
        public bool AllowEntry(TradeType entryDirection)
        {
            ...
            {
                GlobalLogger.Log(_bot, "[NAS GATE] BLOCK extreme spike");
                return false;
            }

            if (IsInCooldown(i))
            {
                GlobalLogger.Log(_bot, "[NAS GATE] BLOCK impulse cooldown");
                return false;
            }
        ...
        private bool IsExtremeSpike(int i, TradeType entryDirection)
        {
            ...
            {
                GlobalLogger.Log(_bot, "[NAS GATE] spike direction mismatch");
                return true;
            }
