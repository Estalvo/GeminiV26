...
//
// SZEREP:
// - AUDUSD instrument-specifikus belépési LOGIKA
...
{
    public class AudUsdEntryLogic : IEntryLogic
    {
        ...
        private const double AdxTrend = 16.0;   // EUR: alacsonyabb küszöb (soft)
        private const double AdxStrong = 23.0;  // EUR: alacsonyabb küszöb (soft)
        ...
        public AudUsdEntryLogic(Robot bot)
        {
            _bot = bot;
        ...
        public void Evaluate()
        {
            ...
            {
                GlobalLogger.Log(_bot, $"[AUDUSD LOGIC] bars insufficient (m5={_m5?.Count ?? 0}, m15={_m15?.Count ?? 0}) -> default bias/conf");
                return;
            }
