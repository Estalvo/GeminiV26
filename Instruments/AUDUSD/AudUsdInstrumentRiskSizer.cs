...
{
    /// <summary>
    /// AUDUSD money-risk policy – Phase 3.6 (BASELINE, NAS 1:1 clone)
    /// Policy szint:
    /// - Risk% (score alapján)
    ...
    /// </summary>
    public class AudUsdInstrumentRiskSizer : IInstrumentRiskSizer
    {
        // =========================
            ...
            out double tp2Ratio)
        {
            ...
            // ===== TP1 ratio – JUTALMAZÁS =====
            if (score >= 85)
                tp1Ratio = 0.40;   // hagyjuk futni
            else if (score >= 75)
                tp1Ratio = 0.55;
            else
                tp1Ratio = 0.70;   // védekező

            // ===== TP2 R – FORDÍTOTT logika =====
            if (score >= 85)
                tp2R = 1.6;
            else if (score >= 75)
                tp2R = 1.3;
