...
{
    public class BtcUsdEntryLogic
    {
        private readonly Robot _bot;

        public BtcUsdEntryLogic(Robot bot)
        {
            _bot = bot;
        }

        /// <summary>
        /// Calculates BTC-specific directional bias and logic confidence.
